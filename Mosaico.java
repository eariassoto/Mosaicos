/*
 * La clase Mosaico contiene la representación logica del mosaico
...
public class Mosaico implements Serializable {
	...
	/** La matriz de enteros mosaico, donde se guardará el mosaico actual. */
	private int[][] mosaico;
	...
	/**
	 * El vector con los colores que se pueden hacer (se pueden agregar más sin
	 * modificar mas codigo, excepto el tamaño del JFrame de VentanaPrincipal y
	 * su respectivo nombre.
	 */
	private Color[] color = new Color[] { Color.WHITE, Color.BLACK, Color.CYAN,
			Color.BLUE, Color.RED, Color.ORANGE, Color.PINK, Color.GRAY,
			Color.MAGENTA };

	/** Los nombres de los colores. */
	private String[] nombreColor = new String[] { "blanco", "negro", "celeste",
			"azul", "rojo", "naranja", "rosado", "gris", "magenta" };
